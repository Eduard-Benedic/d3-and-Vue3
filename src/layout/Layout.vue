...
<template>
  <div class="h-screen flex overflow-hidden bg-gray-100">
    ...
    <div class="hidden bg-main md:flex md:flex-shrink-0">
          ...
          <div class="mt-5 flex-1 flex flex-col">
            <nav class="flex-1 px-2 space-y-1">
              <router-link v-for="item in navigation" 
                          :key="item.name" 
                          :to="{name: item.routeAlias}"
                          @click="item.isLogout ? doLogout() : ''"
                          :class="[item.current ? 'bg-main-hover text-white' 
                                                : 'text-indigo-100 hover:bg-main-hover', 'group flex items-center px-2 py-2 text-sm font-medium rounded-md'
                                  ]">
...
const navigation = [
  { name: 'Dashboard',  routeAlias: 'Dashboard', icon: HomeIcon, current: true},
  { name: 'Charts',  routeAlias: 'Charts', icon: ChartBarIcon, current: true},
]
